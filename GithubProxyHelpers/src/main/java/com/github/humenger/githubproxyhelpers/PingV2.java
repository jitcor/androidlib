...
class PingV2 implements Runnable {
    public static final int DEFAULT_COUNT = 10;
    public static final long TIMED_OUT_MS = -1;
    private static final String TAG = PingV2.class.getSimpleName();
     ...
     * @param listener
     */
    public PingV2(final InetAddress dest, final PingListener listener) {
        mDest = dest;
        if (listener == null) {
