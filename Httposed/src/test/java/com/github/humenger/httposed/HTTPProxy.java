...
public final class HTTPProxy {
    ...
    static final int LOCAL_PORT = Integer.parseInt(System.getProperty("localPort", "28081"));
    static final String REMOTE_HOST = System.getProperty("remoteHost", "localhost");
    static final int REMOTE_PORT = Integer.parseInt(System.getProperty("remotePort", "28080"));
